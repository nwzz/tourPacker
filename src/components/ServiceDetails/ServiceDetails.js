    ...
    return (
        <div className="mt-5 container">
            ...
            <div className=" row d-flex">
                <div className="col-md-5"><br />
                    ...
                    : <h4 style={{color:'darkblue'}}>Wow!! <span style={{color:'tomato'}}>{newService.name}</span> Your Selected Package</h4>}
                    {
                        ...
                        <div className="d-flex service-decor " >
                            <div><img src={newService.img} alt="" /></div>
                            <div className="d-grid justify-content-start align-content-start">
                                <h3>{newService.name}</h3>
                                <p>Package: <span style={{ color: 'tomato' }}>{newService.duration}</span></p>
                ...
                <div className="col-md-1" style={{borderRight:'1px solid cadetblue'}}>
